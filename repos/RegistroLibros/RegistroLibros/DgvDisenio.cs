...
namespace RegistroLibros
{
    internal class DgvDisenio
    {
        public static void Formato(DataGridView pData, int color)
        {
            ...
            pData.DefaultCellStyle.BackColor = SystemColors.InactiveBorder;
            pData.ReadOnly = true;
            ...
            switch (color)
            {
                case 1:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(79, 129, 189);
                    //Fila
                ...
                case 2:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(0, 0, 0);
                    //Fila
                ...
                case 3:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(192, 80, 77);
                    //Fila
                ...
                case 4:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(155, 187, 89);
                    //Fila
                ...
                case 5:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(128, 100, 162);
                    //Fila
                ...
                case 6:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(75, 172, 198);
                    //Fila
                ...
                case 7:
                    ...
                    pData.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(247, 150, 70);
                    //Fila
