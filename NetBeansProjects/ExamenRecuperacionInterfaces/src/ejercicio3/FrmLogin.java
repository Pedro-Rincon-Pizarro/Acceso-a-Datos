...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       boolean register = false;
        for(User u : FrmPrincipal.arrayUsers)
        {
            if(u.getEmail().equals(txtEmailLogin) && u.getPassword().equals(txtPasswordLogin))
            {
                register = true;
            }
        }
        ...
        if(register)
        {
            JOptionPane.showMessageDialog(this, "Sesión iniciada correctamente " , "Error", JOptionPane.INFORMATION_MESSAGE);
            
        }
        else
        {
            JOptionPane.showMessageDialog(this, "El usuario no está registrado" , "Error", JOptionPane.INFORMATION_MESSAGE);
        }
